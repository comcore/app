...
public class EnterCodeDialog extends DialogFragment {
    ...
    public EnterCodeDialog(Fragment fragment, SuccessCallback callback) {
        this(fragment, 0, 0, callback, R.string.confirm_email);
    }

    public EnterCodeDialog(Fragment fragment, int success, int failure) {
        this(fragment, success, failure, null, R.string.confirm_email);
    }
    ...
    private void repeat(int message) {
        new EnterCodeDialog(fragment, success, failure, callback, message)
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return new AlertDialog.Builder(getActivity())
                ...
                .setNegativeButton(R.string.cancel, failure == 0 ? null : (dialog, id) -> {
